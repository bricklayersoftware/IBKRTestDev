...
namespace IBApi
{
    ...
    public class EClientSocket : EClient,  EClientMsgSink
    {
        ...
        */
        ...
        protected override int prepareBuffer(BinaryWriter paramsList)
        {
            var rval = (int)paramsList.BaseStream.Position;
        ...
        protected override void CloseAndSend(BinaryWriter request, int lengthPos)
        {
            if (useV100Plus)
            {
