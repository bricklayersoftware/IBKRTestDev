...
namespace IBKRRealTimeMarketDataApp
{
    ...
    {
        public static Func<string> methodpreamle = () =>
        {
        ...
        {
            Console.WriteLine(methodpreamle() + msg);
        };
        ...
        {
            Request.InvalidateRequest(id, errorCode + " | " + errorMsg + " | " + advancedOrderRejectJson);
        ...
        // field --> https://interactivebrokers.github.io/tws-api/tick_types.html
        // attribs --> https://interactivebrokers.github.io/tws-api/classIBApi_1_1TickAttrib.html#details
        //! [tickprice]
        ...
        /*
            string 	Time [get, set]
                ...
                according to the request). Time zone is the TWS time zone chosen on login.
        ...
        */
        ...
        {
            // 2b7056397a90732100618619e89c82f5 
            ...
            dict.Add("Source", "historicalData");
            dict.Add("Time", bar.Time);
            dict.Add("Open", bar.Open.ToString());
            dict.Add("High", bar.High.ToString());
            dict.Add("Low", bar.Low.ToString());
            dict.Add("Close", bar.Close.ToString());
            dict.Add("Volume", bar.Volume.ToString());
            dict.Add("Count", bar.Count.ToString());
            dict.Add("WAP", bar.WAP.ToString());
        ...
        public virtual void historicalDataEnd(int reqId, string startDate, string endDate)
        {
            ...
            req.ibkrrequestbegindatetime = startDate;
            req.ibkrrequestenddatetime = endDate;
